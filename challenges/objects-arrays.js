...
// tyrannosaurus, carnivorous, 7000kg, 12m, Late Cretaceous
    ...
    var tyrannosaurus = new Dino('tyrannosaurus', 'carnivorous', '7000kg', '12m', 'Late Cretaceous');

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic

    var stegosaurus = new Dino('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic');

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous

    var velociraptor = new Dino('velociraptor', 'carnivorous', '15kg', '1.8m', 'Late Cretaceous');
